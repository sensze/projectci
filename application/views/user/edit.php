    ...
    <div class="row">
        ...
        <?= $this->session->flashdata('message') ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" value="<?= $user['user_nama'] ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="nrp" name="nrp" value="<?= $user['user_nrp'] ?>" readonly>
                </div>
            </div>
            <div class="form-group row">
